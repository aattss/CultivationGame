...
export class GameInitializer {
     ...
     * @private
     */
    static _calculatePotential() {
        // Add meridian talent average
        let meridianAverage = gameState.meridianTalent.reduce((sum, talent) => sum + talent, 0) / gameState.meridianTalent.length;
